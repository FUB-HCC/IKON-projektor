...
const fieldsMapping = [
  { name: "Naturwissenschaften", field: 1, color: "#1f77b4" },
  { name: "Lebenswissenschaften", field: 2, color: "#aec7e8" },
  { name: "Geistes- und Sozialwissenschaften", field: 3, color: "#ff7f0e" },
  { name: "Ingenieurwissenschaften", field: 4, color: "#ffbb78" },
