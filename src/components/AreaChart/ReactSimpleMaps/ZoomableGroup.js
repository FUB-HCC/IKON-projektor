...
class ZoomableGroup extends Component {
  ...
  handleResize() {
    ...
    const resizeFactorX = calculateResizeFactor(
      this.zoomableGroupNode.parentNode.getBoundingClientRect().width,
      width
    );
  ...
  componentDidMount() {
    ...
    this.zoomableGroupNode.addEventListener(
      "touchmove",
  ...
  render() {
    ...
    return (
      <g
        ...
        ref={zoomableGroupNode => {
          this.zoomableGroupNode = zoomableGroupNode;
        }}
        transform={`
           translate(
