...
class AreaChart extends React.Component {
  componentDidMount () {
    ...
    this.Graph.updateData(this.props.projects, this.props.institutions, this.props.width, this.props.height)
  }
  ...
  render () {
    return (<AreaChartView ref={(node) => { this.Graph = node }} width={this.props.width} height={this.props.height} onProjectClick={this.props.onProjectClick} />)
  }
}
