...
d3.select("div.layout")
  .append("p")
  .attr("name", "anweisung")
  .text("Im Folgenden sollen Transitionen von Clustern und deren Hüllen evaluiert werden. Mache dich dazu mit der Benutzeroberfläche etwas vertraut! Jedes Projekt wird durch einen Punkt dargestellt und hat eine eindeutige Identifikationsnummer (ID). Projekte, die sich sehr ähnlich sind, werden einem Cluster zugeordnet - hier durch eine graue Hülle dargestellt - und liegen tendenziell näher beieinander.");
...
var datas = [
  [[7,0,0], [2,1,0], [8,3,0], [5,5,0], [1,2.8,0], [6,1.5,0]] // cluster 0
];
for(var c in datas){
...
datas = [
  [[7,0,0], [2,1,0], [8,3,0], [5,5,0], [1,2.8,0], [6,1.5,0], [4,2.5,0], [5.2,3.5,0]] // cluster 0
  ];
