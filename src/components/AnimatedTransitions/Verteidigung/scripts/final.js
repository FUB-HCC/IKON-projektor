...
////////////////// Forschungsgebiete /////////////////////
zelleLinks.append("p").text("Forschungsgebiete:");
var radios = zelleLinks.selectAll('input[name="forschungsgebiete"]')
...
zelleLinks.append("p").text("Parameterwechsel:");
var divPerspective = zelleLinks.append("div")
...
////////////// Transitionsdauer ///////////////
zelleRechts.append("p").text("Transitionsdauer:");
new DurationRegler(zelleRechts);

////////// Darstellung //////////
zelleRechts.append("p").text("Darstellung:").style("margin-top", "5.5ex");
var divSelectDarst = zelleRechts.append("div")
  .style("width", "100%")
  .style("text-align", "left");
...
////////// Färbung //////////
zelleRechts.append("p").text("Projektfarbe:");
var divSelectColor = zelleRechts.append("div")
  .style("width", "100%")
  .style("text-align", "left");
...
////////// Hüllensichtbarkeit //////////
zelleRechts.append("p").text("Hüllensichtbarkeit:");
var divSelectOpacity = zelleRechts.append("div")
  .style("width", "100%")
  .style("text-align", "left");
