...
function update(){// nach einmaliger Betätigung erscheinen Buttons
  ...
  function createForm() {
    ...
    toolT8 = new Tooltip(document.getElementById("frage"), "Zur ersten Aufgabe geht es durch Drücken dieses Buttons.", weiterGehts);
  }
}
...
function hinweis6(){
  ...
  toolT6 = new Tooltip(document.getElementsByClassName("huelle")[3], "Ein Cluster - hier durch eine graue Hülle dargestellt - fasst mehrere Projekte als Einheit zusammen und hat ebenfalls eine Identifikationsnummer (ID).", hinweis7);
