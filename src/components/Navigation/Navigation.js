      ...
      <div onClick={() => props.changeGraph('0')} className={classes.NavElement}>
        <svg height="90%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          ...
          <g fill={props.active === '0' ? '#f0faf0' : '#989aa1'} stroke={props.active === '0' ? '#f0faf0' : '#989aa1'}>
            ...
            <polygon
              points="136 229.84 109.89 229.84 91.43 248.31 91.43 274.42 109.89 292.88 136 292.88 154.46 274.42 154.46 248.31 136 229.84"/>
            ...
            <polygon
              points="167.52 65.33 141.41 65.33 122.94 83.8 122.94 109.91 141.41 128.37 167.52 128.37 185.98 109.91 185.98 83.8 167.52 65.33"/>
            <polygon
              points="317.16 136.26 291.05 136.26 272.58 154.72 272.58 180.83 291.05 199.3 317.16 199.3 335.62 180.83 335.62 154.72 317.16 136.26"/>
            <polygon
              points="218.2 270.23 192.09 270.23 173.63 288.69 173.63 314.8 192.09 333.26 218.2 333.26 236.66 314.8 236.66 288.69 218.2 270.23"/>
      ...
      <div onClick={() => props.changeGraph('1')} className={classes.NavElement}>
        <svg height="90%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          ...
          <g fill={props.active === '1' ? '#f0faf0' : '#989aa1'}>
            ...
            <polygon
              points="190.93 126.14 178.09 138.99 178.09 334.61 190.93 347.45 209.09 347.45 221.94 334.61 221.94 138.99 209.09 126.14 190.93 126.14"/>
            <polygon
              points="99.42 45.21 86.57 58.05 86.57 257.29 99.42 270.13 117.58 270.13 130.42 257.29 130.42 58.05 117.58 45.21 99.42 45.21"/>
      ...
      <div onClick={() => props.changeGraph('2')} className={classes.NavElement}>
        <svg height="90%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400">
          ...
          <g fill={props.active === '2' ? '#f0faf0' : '#989aa1'}>
            ...
            <polygon
              points="207.04 86.75 166.42 110.44 145.24 130.55 197.43 153.82 250.89 148.09 291.51 124.4 207.04 86.75"/>
            <polygon
              points="192.95 157.22 141.59 133.19 105.03 163.91 64.41 187.6 148.89 225.25 189.5 201.56 192.95 157.22"/>
          </g>
        </svg>
      </div>
    </div>
